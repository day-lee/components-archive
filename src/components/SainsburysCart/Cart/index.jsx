  ...
  return (
    <div className="flex">
      <div className="mt-2 w-full">
        ...
        {isHovered && (
          <div className="sm:block absolute top-[180px] right-0 sm:right-12 bg-gray-200 shadow-2xl border-[1px] sm:w-1/4 min-w-[410px] max-h-[500px] min-h-[200px] overflow-scroll">
