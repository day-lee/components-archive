...
function MemeGenerator() {
  ...
  return (
    <>
      <div className="flex justify-center w-[80vpw] max-w-[700px]">
        <div className="border-[1px] border-gray">
          <header className="flex items-center bg-gradient-to-r from-[#672280] to-[#A626D3] w-full h-[65px] text-white font-bold p-4">
